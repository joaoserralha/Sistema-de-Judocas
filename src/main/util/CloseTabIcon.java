...
/**
 * This class encapsulates an icon that can be added to the selector tab of a
 * JTabbedPane to allow
...
public class CloseTabIcon implements Icon {
	...
	public void paintIcon(Component component, Graphics g, int x, int y) {
		...
		// Lazily create a link to the owning JTabbedPane and attach a listener to it,
		// so clicks on the
		...
		if (tabbedPane == null) {
			...
			tabbedPane.addMouseListener(new MouseAdapter() {
				...
				public void mouseReleased(MouseEvent e) {
					// asking for isConsumed is *very* important, otherwise more than one tab might
					// get closed!
